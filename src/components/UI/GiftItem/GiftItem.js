...
const GiftItem = props => {
    ...
    return (
        <div className={classes.GiftItem} id={props.id}>
            ...
            <div className={[classes.Checked, classes.Icon].join(' ')}><i className="far fa-check-circle"></i></div>
            <div className={[classes.Delete, classes.Icon].join(' ')}><i className="far fa-times-circle"></i></div>
